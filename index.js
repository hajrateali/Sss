...
app.get('/', (req, res) => {
  res.send(`<h1>Started Server HAJRATEALI</h1>,
  <h2><a href="http://localhost:3000/0001">FIRAT URL</a></h2> <br> <br>
  <h2>Image Show <a href="http://localhost:3000/0002">Click Hear</a><h2>
  `)});
